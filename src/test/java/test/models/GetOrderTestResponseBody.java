...
public class GetOrderTestResponseBody {

    // Список заказов
    @JsonProperty("orders")
    private List<GetOrderTestRequest> orders;
    ...
    // Геттеры и сеттеры
    public List<GetOrderTestRequest> getOrders() {
        return orders;
    }

    public void setOrders(List<GetOrderTestRequest> orders) {
        this.orders = orders;
    }
